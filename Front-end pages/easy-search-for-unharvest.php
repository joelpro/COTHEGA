...
<form action="easy-search-for-unharvest.php" method="post">
...
{
?>
<a href="director-welcome.php"  type="submit" name="closebtn" title="&laquo; close & back"><img src='../Resources/icons/s_error.png' style="width: 18px;" ismap="ismap"  align="right"id="hiddenbtn"  /></a>
<?php
}
?>
...
if(isset($_POST['searchbtn']))
{
 ...
 echo"<script>location.href='unharvester-report.php';</script>";
}
?>
<!-------------------- Search box ends ---------------------------------------------------->
